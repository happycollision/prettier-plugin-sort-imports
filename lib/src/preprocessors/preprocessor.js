...
function preprocessor(code, options) {
    ...
    var allImports = (0, get_sorted_nodes_1.getSortedNodes)(importNodes, {
        ...
        importOrderSeparationGroups: importOrderSeparationGroups,
